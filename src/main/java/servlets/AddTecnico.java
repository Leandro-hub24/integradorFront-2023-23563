...
/**
 * Servlet implementation class AddTecnico
 */
public class AddTecnico extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		TecnicoCont.CrearTecnico(nombre, apellido);
		
		pw.println("<h1>Tecnico agregado satisfactoriamente</h1>");
